    ...
    <div class="pet-register-wrapper">
      ...
      <form @submit.prevent="submitForm" class="pet-register-form">
        ...
        <div class="field-group">
          ...
          <input v-model="form.careNm" type="text" class="input-field" required />
        </div>

        <!-- 보호소 코드 -->
        <div class="field-group">
          <label class="field-label">보호소 코드 <span class="required">*</span></label>
          <input v-model="form.careRegNo" type="text" class="input-field" required />
        </div>
        ...
        <div class="field-group">
          ...
          <div class="address-group">
            <input v-model="form.careAddr" type="text" class="input-field address-input" readonly required />
        ...
        <div class="field-group">
          ...
          <input v-model="form.careTel" type="text" class="input-field" required />
        </div>
