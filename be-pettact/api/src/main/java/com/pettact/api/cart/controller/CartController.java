...
public class CartController {
    ...
    public ResponseEntity<String> deleteProduct(@AuthenticationPrincipal CustomUserDetails user, @PathVariable("cartId") Long cartId) {
        cartService.deleteProduct(user.getUserEntity(),cartId);
